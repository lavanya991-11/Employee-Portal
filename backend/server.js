...
const identificationTypeRoutes = require('./routes/identificationTypeRoutes');
const identityDocumentRoutes = require('./routes/identityDocumentRoutes');
...
app.use('/api/identification-types', identificationTypeRoutes);
app.use('/api/identity-documents', identityDocumentRoutes);
