...
// Teal 4-point star gem (Business Central logo style).
const BcGem = () => (
    <svg width="44" height="44" viewBox="0 0 48 48" fill="none">
        <polygon points="24,4 29,19 24,24 19,19" fill="#67e8f9" />
        <polygon points="44,24 29,29 24,24 29,19" fill="#0891b2" />
        <polygon points="24,44 19,29 24,24 29,29" fill="#0e7490" />
        <polygon points="4,24 19,19 24,24 19,29" fill="#22d3ee" />
    </svg>
);
