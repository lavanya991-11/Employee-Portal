...
function Sidebar() {
    ...
    useEffect(() => {
        settingsApi.get().then(({ data }) => {
            ...
            // Apply the admin-configured input field colour app-wide.
            const fc = s.fieldColor || '';
            if (fc) {
                document.documentElement.style.setProperty('--input-border', fc);
                localStorage.setItem('fieldColor', fc);
            } else {
